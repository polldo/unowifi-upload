...
stk500.prototype.upload = function (stream, hex, pageSize, timeout, board, done) {
  this.log("program");

  var pageaddr = hex.startSegmentAddress != null ? hex.startSegmentAddress : 0;
  hex = hex.data;
  var writeBytes;
  var useaddr;
...
stk500.prototype.verify = function (stream, hex, pageSize, timeout, board, done) {
  this.log("verify");
...
stk500.prototype.bootload = function (stream, hex, opt, done) {
  ...
  async.series([
    ...
    this.upload.bind(this, stream, hex, opt.pageSize, opt.timeout, opt.name),
    this.verify.bind(this, stream, hex, opt.pageSize, opt.timeout, opt.name),
